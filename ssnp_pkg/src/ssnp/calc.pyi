...
def ssnp_step(u: GPUArray, u_d: GPUArray, dz: Real, n: GPUArray = None, output: GPUArray = None,
              stream: Stream = None) -> Tuple[GPUArray, GPUArray]: ...
...
def ssnp_grad_bp(u, ug, u_dg, dz, n=None, ng=None, stream: Stream = None) -> GPUArray: ...
...
def get_multiplier(arr_like, res=None, stream: Stream = None): ...
...
def split_prop(u: GPUArray, u_d: GPUArray, copy: bool = False, stream: Stream = None) -> Tuple[GPUArray, GPUArray]: ...


def merge_grad(ufg: GPUArray, ubg: GPUArray, copy: bool = False,
               stream: Stream = None) -> Tuple[GPUArray, GPUArray]: ...
