from typing import Callable, overload, Literal, Tuple, Optional, Union, Sequence
...
class Multipliers:
    ...
    @overload
    def binary_pupil(self, na, n0=1, *, prop_offset: Sequence[Real] = None, gpu: Literal[True]) -> GPUArray: ...

    @overload
    def binary_pupil(self, na, n0=1, *, gpu: Literal[False] = False) -> ndarray: ...

    @overload
    def c_gamma(self, shift: Optional[Union[Sequence, Real]] = 0, *, gpu: Literal[True]) -> GPUArray: ...

    @overload
    def c_gamma(self, shift: Optional[Union[Sequence, Real]] = 0, *, gpu: Literal[False] = False) -> ndarray: ...

    @staticmethod
    def _near_0(size, pos_0, edge: bool = True): ...
